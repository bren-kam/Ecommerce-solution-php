<table cellpadding="0" cellspacing="0" class="form">
	...
	<tr>
		...
		<td>
			<div id="dCouponContent"><?php if ( !empty( $coupon ) ) { ?><img src="<?php echo ( stristr( $coupon['value'], 'http' ) ) ? $coupon['value'] : 'http://' . $user['website']['domain'] . $coupon['value']; ?>" alt="<?php echo _('Coupon'); ?>" style="padding-bottom: 10px;" /><br /><?php } ?></div>
