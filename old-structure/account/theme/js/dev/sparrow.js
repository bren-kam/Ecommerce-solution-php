...
var sparrow = function(context) {
	...
	head.js( '/js2/?f=jquery.datatables', function() {
		...
		tables.addClass('dt').each( function() {
			...
			var aPerPage = $(this).attr('perPage').split(','), opts = '', ths = $(this).find('th').append('<img src="/images/trans.gif" width="10" height="8" />'), sorting = new Array(), columns = new Array(), s = '', c = '', a = $(this).attr('ajax');
