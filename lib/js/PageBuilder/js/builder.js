...
editableItems['.product'] = ['data-product'];
editableItems['.bg.bg1'] = ['background-color'];
editableItems['nav a, a.edit'] = ['color', 'font-weight', 'text-transform', 'background-color'];
...
editableItems['.welcome-1 > .p1'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.btn-1'] = ['border-radius', 'font-size', 'background-color', 'border-color', 'color'];
editableItems['.navbar-nav > li > a > i'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['i'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.left > span'] = ['color', 'font-size', 'background-color', 'font-family'];
editableItems['.header-1'] = ['background-image', 'background-color'];
editableItems['.header-2'] = ['background-image', 'background-color'];
editableItems['.header-3'] = ['background-image', 'background-color'];
editableItems['.header-4'] = ['background-image', 'background-color'];
editableItems['.header-5'] = ['background-image', 'background-color'];
editableItems['.header-6'] = ['background-image', 'background-color'];
editableItems['.header-7'] = ['background-image', 'background-color'];
editableItems['.header-8'] = ['background-image', 'background-color'];
editableItems['.header-9'] = ['background-image', 'background-color'];
editableItems['.header-10'] = ['background-image', 'background-color'];
editableItems['.welcome-3 .right .circle'] = ['background-color'];
editableItems['.side-menu li a'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.sidenav'] = ['background-color'];
editableItems['.bottomh1'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.tagline'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.b-btn'] = ['border-radius', 'font-size', 'background-color', 'border-color', 'color'];
editableItems['.c-btn'] = ['border-radius', 'font-size', 'background-color', 'border-color', 'color'];
editableItems['nav a'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['nav > span'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.header-9 > .navbar'] = ['background-color'];
editableItems['.services-1'] = ['background-image', 'background-color'];
editableItems['.services-2'] = ['background-image', 'background-color'];
editableItems['.services-3'] = ['background-image', 'background-color'];
editableItems['.services-4'] = ['background-image', 'background-color'];
editableItems['.services-5'] = ['background-image', 'background-color'];
editableItems['.services-6'] = ['background-image', 'background-color'];
editableItems['.services-7'] = ['background-image', 'background-color'];
editableItems['.services-8'] = ['background-image', 'background-color'];
editableItems['.service-box'] = ['background-color'];
editableItems['.about-1'] = ['background-image', 'background-color'];
editableItems['.name'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.position'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.about-2'] = ['background-image', 'background-color'];
editableItems['.mem'] = ['background-color'];
editableItems['.about-3'] = ['background-image', 'background-color'];
editableItems['.about-4'] = ['background-image', 'background-color'];
editableItems['.info'] = ['background-color', 'border-radius'];
editableItems['.about-5'] = ['background-image', 'background-color'];
editableItems['.content-1'] = ['background-image', 'background-color'];
editableItems['.content-2'] = ['background-image', 'background-color'];
editableItems['.content-3'] = ['background-image', 'background-color'];
editableItems['.content-4'] = ['background-image', 'background-color'];
editableItems['.r-btn'] = ['border-radius', 'font-size', 'background-color', 'border-color', 'border-width', 'color'];
editableItems['.box'] = ['background-color'];
editableItems['.content-5'] = ['background-image', 'background-color'];
editableItems['.text'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.heading'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.rate'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.shop-btn'] = ['border-radius', 'font-size', 'background-color', 'border-color', 'border-width', 'color'];
editableItems['.content-6 .right'] = ['background-image', 'background-color'];
editableItems['.content-7 .left'] = ['background-image', 'background-color'];
editableItems['.content-8'] = ['background-image', 'background-color'];
editableItems['.content-9'] = ['background-image', 'background-color'];
editableItems['.content-10'] = ['background-image', 'background-color'];
editableItems['.txt'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.txt2'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.content-11'] = ['background-image', 'background-color'];
editableItems['.login'] = ['background-image', 'background-color'];
editableItems['.login-wrap'] = ['background-color'];
editableItems['.input-group-addon'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.recover'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.error'] = ['background-image', 'background-color'];
editableItems['.heading1'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.heading2'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.links li a'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.portfolio-1'] = ['background-image', 'background-color'];
editableItems['.filter li a'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.blog-1'] = ['background-image', 'background-color'];
editableItems['.number'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.by'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.category'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.date'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.r-more'] = ['border-radius', 'font-size', 'background-color', 'border-color', 'border-width', 'color'];
editableItems['blockquote'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight', 'border-color'];
editableItems['.tags'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.reply-btn'] = ['border-radius', 'font-size', 'background-color', 'border-color', 'border-width', 'color'];
editableItems['.table-head'] = ['background-image', 'background-color'];
editableItems['.plan'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.line'] = ['border-color'];
editableItems['.purchase'] = ['border-radius', 'font-size', 'background-color', 'border-color', 'border-width', 'color'];
editableItems['.table-body li'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.pricing-1'] = ['background-image', 'background-color'];
editableItems['.partners-1'] = ['background-image', 'background-color'];
editableItems['.contact-1'] = ['background-image', 'background-color'];
editableItems['address'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.snd-btn'] = ['border-radius', 'font-size', 'background-color', 'border-color', 'border-width', 'color'];
editableItems['.footer-1'] = ['background-image', 'background-color'];
editableItems['.footer-2'] = ['background-image', 'background-color'];
editableItems['.footer-3'] = ['background-image', 'background-color'];
editableItems['.footer-4'] = ['background-image', 'background-color'];
editableItems['.footer-5'] = ['background-image', 'background-color'];
editableItems['.footer-6'] = ['background-image', 'background-color'];
editableItems['.footer-7'] = ['background-image', 'background-color'];
editableItems['.footer-8'] = ['background-image', 'background-color'];
editableItems['.posts li a'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.f-socials li a'] = ['background-color', 'border-radius'];
editableItems['.grid'] = ['background-image', 'background-color'];
editableItems['.top-bar'] = ['background-image', 'background-color'];
editableItems['.navbar'] = ['background-image', 'background-color'];
editableItems['.navbar-6'] = ['background-image', 'background-color'];
editableItems['.navbar-6 .right a'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight', 'border-color', 'border-width'];
editableItems['.navbar-6 .right strong'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.navbar-9'] = ['background-image', 'background-color'];
editableItems['.intro-1'] = ['background-image', 'background-color'];
editableItems['.btn-2'] = ['border-radius', 'font-size', 'background-color', 'border-color', 'border-width', 'color'];
editableItems['.intro-2'] = ['background-image', 'background-color'];
editableItems['.intro-3'] = ['background-image', 'background-color'];
editableItems['.intro-3 .right span'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.intro-3 .right .reviews'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.intro-4'] = ['background-image', 'background-color'];
editableItems['.intro-4 .box'] = ['background-color', 'border-radius'];
editableItems['.submit'] = ['border-radius', 'font-size', 'background-color', 'border-color', 'border-width', 'color'];
editableItems['.intro-5'] = ['background-image', 'background-color'];
editableItems['.intro-5 .l-text'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.intro-5 .l-text .r-color'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.intro-5 .under-rate'] = ['color', 'font-size', 'background-color', 'font-family', 'font-weight'];
editableItems['.intro-6'] = ['background-image', 'background-color'];
editableItems['.join'] = ['border-radius', 'font-size', 'background-color', 'border-color', 'border-width', 'color'];
...
editableItemOptions['.info : border-radius'] = ['1px', '2px', '3px', '4px', '5px',];


var editableContent = ['p', 'h1', 'h2', 'h3', 'h4', '.btn', '.header-1', '.header-2', '.header-3', '.header-4', '.header-5', '.header-6', '.header-7', '.header-8', '.header-9', '.header-10', '.welcome-1 .p1', '.btn-1', '.welcome-1 h1', '.navbar-nav > li > a', '.top-bar .left', '.top-bar .left i', '.left > span', '.welcome-3 .right .circle', '.side-menu li a', '.sidenav', '.bottomh1', '.tagline', '.b-btn', '.c-btn', 'nav a', 'nav > span', '.header-9 > .navbar', '.name', '.position', '.r-btn', '.text', '.heading', '.rate', '.shop-btn', '.txt', '.txt2', '.input-group-addon', '.recover', '.heading1', '.heading2', '.links li a', '.filter li a', '.number', '.by', '.category', '.date', '.r-more', 'blockquote', '.tags', '.socials', '.reply-btn', '.plan', '.purchase', '.table-body li', 'address', '.snd-btn', '.posts li a', '.navbar-6 .right a', '.navbar-6 .right strong', '.btn-2', '.intro-3 .right span', '.intro-3 .right .reviews', '.submit', '.intro-5 .l-text', '.intro-5 .under-rate', '.intro-5 .l-text .r-color', '.join',    ];
...
$( window ).load(function() {
    ...
    var saved_content = $('#saved_content').html();
    $.ajax(
	"/website/landing-pages/get_content/?apid="+ $("#page-id").val(),
	{
	    success: function(response){
		localStorage.clear();
		
		var page_content = response.content;
		localStorage.setItem("pageNames", JSON.stringify(page_content.page_names) );
		page_content.storage.forEach(function(element,index,arr){
		    localStorage.setItem("blocksElement" + element.count, JSON.stringify(element.blocksElement));
		    localStorage.setItem("blocksFrame" + element.count, JSON.stringify(element.blocksFrame));
		});
...
function makeSortable(el) {
	...
	beforeStop: function(event, ui){
		...
		productButton = $('<button type="button" class="btn btn-inverse productBlock"><i class="fa fa-shopping-cart"></i> Products </button>');
        	cognitoButton = $('<a href="http://www.cognitoforms.com" target="_blank" class="btn btn-success "><i class="fa fa-list-alt"></i> Cognito Forms </a>');
		...
		frameCover.append( productButton );
		frameCover.append( cognitoButton );
...
function styleClick(el) {
	...
	if( $(el).parent().prop('tagName') == 'A' ) {
	    ...
	    if( $('input#internalLinksCustom').val() != '' ) {
...
$(function(){
    ...
    /*
      $('#styleEditor form').on("keydown", "input", function(){

      
      if( 'data-product' == $(this).attr('name')){
	...
	if( $(this).val() == 'content' ) {
		...
		for (i=0; i<editableContent.length; ++i) {
			...
			if( this.tagName == 'SMALL' || this.tagName == 'A' || this.tagName == 'LI' || this.tagName == 'SPAN' || this.tagName == 'B' || this.tagName == 'I' || this.tagName == 'TT' || this.tageName == 'CODE' || this.tagName == 'EM' || this.tagName == 'STRONG' || this.tagName == 'SUB' || this.tagName == 'BUTTON' || this.tagName == 'LABEL' || this.tagName == 'P' || this.tagName == 'H1' || this.tagName == 'H2' || this.tagName == 'H2' || this.tagName == 'H3' || this.tagName == 'H4' || this.tagName == 'H5' || this.tagName == 'H6' ) {
				...
				buttons: ['html', 'bold', 'italic', 'deleted', 'link','image','formatting', 'alignment'],
				focus: true,
   ...
   //block products 
    $('#pageList').on("click", ".frameCover > .productBlock", function(){
		//hide the iframe
	...
	var autocomplete = new Bloodhound({
	    ...
	    remote: {
		url: '/products/autocomplete-owned/?_nonce=' + _nonce + '&type[]=name&type[]=sku&owned=1&term=%QUERY',
	...
	var pageDiv = $(this).closest('li').find('iframe').contents().find( pageContainer ).clone();

	header =  $('<p><label>Please select the products you want to display</label></p>');
	
	$('#theContent').remove();
	theContent =  $('<div id="theContent" style="display:none;"></div>');
	theForm = $('<div  class="col-lg-6" style="-webkit-box-shadow: -1px 1px 10px 0px rgba(156,156,156,1);-moz-box-shadow: -1px 1px 10px 0px rgba(156,156,156,1);box-shadow: -1px 1px 10px 0px rgba(156,156,156,1);position:absolute;right:0;top:0;background:#fafafa;padding-left:10px;padding-right:10px;"></div>');
	theForm.append(header);

	$(this).closest('li').append(theContent);
	
	
	if(pageDiv.find('.product').length){
	for(var i = 0; i < pageDiv.find('.product').length; i++){
	    row = $('<div class="col-lg-4"></div>');
	    $('<input type="text" class="form-control" value="" data-index="'+(i + 1)+'" placeholder="Enter product #'+ (i+1) +'" />').appendTo(row).unbind().typeahead('destroy').typeahead(null, {
		displayKey: 'name',
		source: autocomplete.ttAdapter()
	    }).unbind('typeahead:selected')
		.on('typeahead:selected', function(event,selected){
		    var productDiv = pageDiv.find('.product:nth-child('+$(this).attr('data-index')+')');
                    $.get(
			'/products/get/'
			, { '_nonce': $('#_get').val(), 'pid': selected.value }
			, function(r) {
			    console.log(r.product);
			    productDiv.find('.product-title').html(r.product.name);
			    productDiv.find('.product-img img').attr('src',r.product.image);
			    
			    productDiv.find('.product-price').html('$' + r.product.price);
			    productDiv.find('.product-description').html(r.product.description);
			    productDiv.find('.product-add-to-cart').attr('href', r.product.link);
			    
			    theContent.html('');
			    theContent.html(pageDiv.html());
			}
			, 'json'
                    );
	    ...
	    row.appendTo(theForm);
	}
	    
	} else {
	     $('<p><strong>This widget doesn\'t have any product area defined</strong></p>').appendTo(theForm)
	}

	cancelButton = $('<button type="button" class="btn btn-danger editCancelButton btn-wide"><span class="fui-cross"></span> Cancel</button>');
	saveButton = $('<button type="button" class="btn btn-primary editProductsButton btn-wide"><span class="fui-check"></span> Save</button>');
	...
	theForm.appendTo($(this).closest('li'));
    ...
    $('#pageList').on("click", "li .editorButtons .editProductsButton", function(){
...
function savePage(e) {
	...
	localStorage['blocksFrame'+pageCounter] = JSON.stringify(blocksFrame);
        dbStorage.push({
	    blocksElement: blocksElement,
	    blocksFrame: blocksFrame,
	    count: pageCounter,
	});
	...
	newInput =  "<html>"+$('iframe#skeleton').contents().find('html').html()+"</html>";
    ...
    $.ajax({
	url:'/website/landing-pages/save/?apid=' + $("#page-id").val(),
	type: 'POST',
	data: {page_names: pageNames, storage: dbStorage, renderedContent: newInput }
    });
