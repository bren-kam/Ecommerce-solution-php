...
function makeSortable(el) {
	...
	beforeStop: function(event, ui){
		...
		productButton = $('<button type="button" class="btn btn-inverse productBlock"><i class="fa fa-cart"></i> Set Product </button>');
   ...
   //block products 
	...
	for(var i = 0; i < pageDiv.find('.product').length; i++){
		...
		.on('typeahead:selected', function(event,selected){
			...
			, function(r) {
			    productDiv.find('h3').html(r.product.name);
			    productDiv.find('.product-img img').attr('src',r.product.image);
			    productDiv.find('.description').html(r.product.description);
