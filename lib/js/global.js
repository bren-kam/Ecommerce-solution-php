...
var TicketForm = {
    ...
    , init: function() {
        ...
        $('#fCreateTicket select#tTicketTopic').on('change', function (e) {
            ...
            switch (this.value) {
                case 'design':
                    placeholderVal = 'Logo: Please Attach\nColors: Indicate 3\nTheme: Paste theme here';
                    break;
                case 'development':
                case 'bug':
                    placeholderVal =
                        ...
                        + '*a clear description of the issues you are seeing.\n'
                        + '*The steps that we can follow to reproduce the issue.\n'
                        + '*A link to where the issue can be seen and any relevant screenshots.\n\n'
                        + '(bullet points)\n\n'
                        + 'Thank You,\n'
                        + 'Technical Team\n\n'
                        + '(attached screenshot in description box)\n';
                    break;
                default:
                    break;
            }
