...
class Archives extends Base_Class {
	 ...
	 */
	 public function add_page( $website_page_id, $request_id, $param ) {
		//Fix for arrays
		$this->db->insert( 'archive_pages', array('website_page_id' => $website_page_id, 'request_id' => $request_id, 'content' => nl2br( $param['content'] ), 'meta_title' => $param['meta_title'], 'meta_description' => $param['meta_description'], 'meta_keywords' => $param['meta_keywords'], 'date_created' => date_time::date('Y-m-d H:i:s') ), 'iisssss' );
