...
class Base_Class {
	...
	public function error( $message, $line = 0, $file = '', $dir = '', $function = '', $class = '', $method = '', $debug = true ) { 
		...
		$input_data = array( 
			...
			'date_created' => date_time::date('now')
		);
	...
	public function display_error( $message ) {
		echo "<h2 style='color:red'>::DEBUG:: An error has occurred:</h2><p>$message</p><br /><p>To disable these messages, edit s98_fw/config.php file.</p><br />";
	}
}