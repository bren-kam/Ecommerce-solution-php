...
class Social_Media extends Base_Class {
	...
	public function create_email_sign_up() {
		...
		$this->db->insert( 'sm_email_sign_up', array( 'website_id' => $user['website']['website_id'], 'key' => $key, 'date_created' => date_time::date('Y-m-d H:i:s') ), 'iss' );
	...
	public function create_fan_offer() {
		...
		$this->db->insert( 'sm_fan_offer', array( 'website_id' => $user['website']['website_id'], 'key' => $key, 'date_created' => date_time::date('Y-m-d H:i:s') ), 'iss' );
	...
	public function create_sweepstakes() {
		...
		$this->db->insert( 'sm_sweepstakes', array( 'website_id' => $user['website']['website_id'], 'key' => $key, 'date_created' => date_time::date('Y-m-d H:i:s') ), 'iss' );
	...
	public function create_share_and_save() {
		...
		$this->db->insert( 'sm_share_and_save', array( 'website_id' => $user['website']['website_id'], 'key' => $key, 'date_created' => date_time::date('Y-m-d H:i:s') ), 'iss' );
	...
	public function create_facebook_site() {
		...
		$this->db->insert( 'sm_facebook_site', array( 'website_id' => $user['website']['website_id'], 'key' => $key, 'date_created' => date_time::date('Y-m-d H:i:s') ), 'iss' );
	...
	public function create_contact_us() {
		...
		$this->db->insert( 'sm_contact_us', array( 'website_id' => $user['website']['website_id'], 'website_page_id' => $website_page_id, 'key' => $key, 'date_created' => date_time::date('Y-m-d H:i:s') ), 'iiss' );
	...
	public function create_about_us() {
		...
		$this->db->insert( 'sm_about_us', array( 'website_id' => $user['website']['website_id'], 'website_page_id' => $website_page_id, 'key' => $key, 'date_created' => date_time::date('Y-m-d H:i:s') ), 'iiss' );
	...
	public function create_products() {
		...
		$this->db->insert( 'sm_products', array( 'website_id' => $user['website']['website_id'], 'key' => $key, 'date_created' => date_time::date('Y-m-d H:i:s') ), 'iss' );
	...
	public function create_current_ad() {
		...
		$this->db->insert( 'sm_current_ad', array( 'website_id' => $user['website']['website_id'], 'website_page_id' => $website_page_id, 'key' => $key, 'date_created' => date_time::date('Y-m-d H:i:s') ), 'iiss' );
	...
	public function create_analytics() {
		...
		$this->db->insert( 'sm_analytics', array( 'website_id' => $user['website']['website_id'], 'key' => $key, 'date_created' => date_time::date('Y-m-d H:i:s') ), 'iss' );
