...
class Shopping_Cart extends Base_Class {
	...
	public function add_shipping_method( $type, $name, $method, $amount, $extra = '' ) {
		...
		$this->db->insert( 'website_shipping_methods', array( 'website_id' => $user['website']['website_id'], 'type' => $type, 'name' => $name, 'method' => $method, 'amount' => $amount, 'extra' => $extra, 'date_created' => date_time::date('Y-m-d H:i:s') ), 'isssdss' );
