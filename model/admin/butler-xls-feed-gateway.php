...
class ButlerXLSFeedGateway extends ProductFeedGateway {
    ...
    protected $categories = array(
        ...
        , 'CONSOLE TABLE' => 235 // Occasional > Consoles
        ...
        , 'SOFA/CONSOLE TABLE' => 235 // Occasional > Consoles
        ...
        , 'STORAGE TABLE' => 231 // Occasional > Cocktail Tables
        ...
        , 'DEMILUNE CONSOLE' => 235 // Occasional > Consoles
        ...
        , 'PEDESTAL CONSOLE TABLE' => 235 // Occasional > Consoles
        ...
        , 'BUTLER TABLE' => 133 // Dining Room > Buffets
...
//            }
    ...
    protected function send_report() {
        ...
        if( count( $this->new_products ) > 0 ) {
			...
			fn::mail( 'kerry@greysuitretail.com, david@greysuitretail.com, rafferty@greysuitretail.com, productmanager@greysuitretail.com', 'Butler Products - ' . dt::now(), $message );
		}
