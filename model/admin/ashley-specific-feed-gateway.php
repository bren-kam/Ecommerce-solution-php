...
class AshleySpecificFeedGateway extends ActiveRecordBase {
    ...
    protected $testing_sites = array( 78, 123, 124, 134, 186, 190, 243, 291, 292, 317, 318, 327, 335, 337, 354, 357
        , 377, 458, 476, 477, 535, 571, 587, 590, 593, 596, 600, 612, 613, 638, 642, 645, 650, 665, 674, 684, 689, 743
        , 805, 806, 829, 878, 882, 895, 902, 904, 929, 936, 942, 980, 991, 1014, 1017, 1058, 1067, 1068, 1078, 1100
        , 1101, 1116, 1120, 1126, 1129, 1140, 1141, 1147, 1148, 1184, 1197, 1198, 1199, 1206, 1221, 1223
    );
	...
	public function run( Account $account, $file = '' ) {
        ...
        if ( in_array( $account->id, $this->testing_sites ) ) {
