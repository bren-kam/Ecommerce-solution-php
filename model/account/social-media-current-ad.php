<?php
class SocialMediaCurrentAd extends ActiveRecordBase {
    ...
    public function get( $sm_facebook_page_id ) {
        $this->prepare(
            'SELECT `sm_facebook_page_id`, `fb_page_id`, `website_page_id`, `key`, `content` FROM `sm_current_ad` WHERE `sm_facebook_page_id` = :sm_facebook_page_id'
            , 'i'
