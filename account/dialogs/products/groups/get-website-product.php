...
<div class="float-left">
	...
	<table cellpadding="0" cellspacing="0" class="float-left">
		...
		<tr><td colspan="2" class="text-center"><a href="/ajax/products/groups/add-website-product/?_nonce=<?php echo nonce::create( 'add-website-product' ); ?>&amp;pid=<?php echo $product['product_id']; ?>" class="button close" title="<?php echo _('Add Product'); ?>" ajax="1"><?php echo _('Add Product'); ?></a></td></tr>
	</table>
</div>
<br clear="left" />