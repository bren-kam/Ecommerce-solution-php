...
$dir = OPERATING_PATH . 'media/uploads/sitelogos/' . $_POST['wid'] . '/';
...
// Resize the logo
$ajax->ok( image::resize( $_FILES["Filedata"]['tmp_name'], $image_path, 'logo', 350, 150 ), _('An error occurred while trying to upload your logo. Please refresh the page and try again.') );
