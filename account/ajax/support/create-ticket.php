...
if ( '0' == $_POST['hTicketID'] ) {
    ...
    $ajax->ok( $ticket_id = $t->create( format::links_to_anchors( $_POST['tTicketSummary'], true, true ), $_POST['taTicket'] ), _('An error occurred while trying to create your ticket. Please refresh the page and try again') );
} else {
    // Update ticket
