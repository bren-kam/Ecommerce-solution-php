...
if ( '0' == $_POST['hTicketID'] ) {
    ...
    $ajax->ok( $ticket_id = $t->create( strip_tags( $_POST['tTicketSummary'] ), format::links_to_anchors( $_POST['taTicket'], true, true ) ), _('An error occurred while trying to create your ticket. Please refresh the page and try again') );
} else {
    // Update ticket
