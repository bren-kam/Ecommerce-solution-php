...
<div id="dProduct_<?php echo $product['product_id']; ?>" class="product">
	...
	<p class="product-actions" id="pProductAction<?php echo $product['product_id']; ?>">
		...
		<a href="/ajax/products/set-category-image/?_nonce=<?php echo $set_category_image_nonce; ?>&amp;cid=<?php echo $_POST['cid']; ?>&amp;i=<?php echo urlencode( $image_url ); ?>" title="<?php echo _('Set as Category Picture'); ?>" ajax="1" post="1"><?php echo _('Set as Category Picture'); ?></a>
	</p>
</div>
<?php
	}
