	...
	<div id="subcontent">
		<form name="fAddCraigslistTemplate" id="fAddCraigslistTemplate" action="" method="post">
			...
			<div id="dCreateAd" <?php if ( !$ad ) echo ' class="hidden"'; ?>>
                ...
                <input type="text" class="tb" name="tTitle" id="tTitle" value="<?php if ( isset( $ad ) ) echo $ad['title']; ?>" /> <a href="/ajax/get-random-headline/?_nonce=<?php echo nonce::create('random-headline'); ?>&amp;cid=" id="aRandomHeadline" title="<?php echo _('Random Title'); ?>" ajax="1"><?php echo _('Random Title'); ?></a>
                <br /><br />
