<div id="dContactUs">
	...
	<div id="dContactUsList">
		...
		if ( !empty( $contacts ) ) {
			...
			<div class="contact" id="dContact<?php echo $i; ?>">
				...
				<div class="actions">
					<a href="javascript:;" class="delete-address" title="<?php echo _('Delete Address'); ?>"><img src="/images/icons/x.png" width="15" height="17" alt="<?php echo _('Delete Address'); ?>" /></a>
					<a href="javascript:;" class="edit-address" title="<?php echo _('Edit Address'); ?>"><img src="/images/icons/edit.png" width="15" height="17" alt="<?php echo _('Edit Address'); ?>" /></a>
				</div>
			</div>
			<?php } ?>
		<?php } ?>
	...
	<table cellpadding="0" cellspacing="0" class="form">
		...
		<tr>
			<td>&nbsp;</td>
			<td><a href="javascript:;" id="aAddLocation" title="<?php echo _('Add Address'); ?>" tabindex="10"><?php echo _('Add Location'); ?></a></td>
		</tr>
	</table>
	<br />
