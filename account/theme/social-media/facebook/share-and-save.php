        ...
        if ( !isset( $share_and_save['fb_page_id'] ) || 0 == $share_and_save['fb_page_id'] ) {
            ...
            foreach ( $instructions as $step => $data ) {
                ...
                if ( !isset( $data['image'] ) || $data['image'] != false )
                    echo '<br /><p><a href="http://account.imagineretailer.com/images/social-media/facebook/share-and-save/', $step, '.jpg"><img src="http://admin.imagineretailer.com/images/social-media/facebook/share-and-save/', $step, '.jpg" alt="', $data['title'], '" width="750" /></a></p>';
