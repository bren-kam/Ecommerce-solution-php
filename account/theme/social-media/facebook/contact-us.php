...
<div id="content">
	<h1><?php echo _('Contact Us'), ' - ', $facebook_page['name']; ?></h1>
	<br clear="all" /><br />
	<?php get_sidebar( 'social-media/' ); ?>
	<div id="subcontent">
		<?php
        if ( !isset( $contact_us['fb_page_id'] ) || 0 == $contact_us['fb_page_id'] ) {
            // Define instructions
            $instructions = array(
                1 => array(
            ...
            foreach ( $instructions as $step => $data ) {
                ...
                if ( !isset( $data['image'] ) || $data['image'] != false )
                    echo '<br /><p><a href="http://account.imagineretailer.com/images/social-media/facebook/contact-us/', $step, '.jpg"><img src="http://admin.imagineretailer.com/images/social-media/facebook/contact-us/', $step, '.jpg" alt="', $data['title'], '" width="750" /></a></p>';
