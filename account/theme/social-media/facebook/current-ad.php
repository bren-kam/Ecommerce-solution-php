...
if ( !is_array( $social_media_add_ons ) || !in_array( 'current-ad', $social_media_add_ons ) )
...
<div id="content">
	...
	<div id="subcontent">
		...
		<h2 class="title"><?php echo _('Step 1: Go to the Current Ad application.'); ?></h2>
			...
			<br />
			<p><img src="http://account.imagineretailer.com/images/social-media/facebook/current-ad/step2.jpg" class="image-border" width="884" height="521" alt="<?php echo _('Step 2'); ?>" /></p>
			<br /><br />
			...
			<br />
			<p><img src="http://account.imagineretailer.com/images/social-media/facebook/current-ad/step3.jpg" class="image-border" width="883" height="240" alt="<?php echo _('Step 3'); ?>" /></p>
			<br /><br />
			...
			<br />
			<p><img src="http://account.imagineretailer.com/images/social-media/facebook/current-ad/step4.jpg" class="image-border" width="750" height="594" alt="<?php echo _('Step 4 - 1'); ?>" /></p>
			<br />
			...
			<br />
			<p><img src="http://account.imagineretailer.com/images/social-media/facebook/current-ad/step4-1.jpg" class="image-border" width="673" height="187" alt="<?php echo _('Step 4 - 2'); ?>" /></p>
			<br /><br />
			...
			<p><?php echo _('Facebook Connection Key'); ?>: <?php echo $current_ad['key']; ?></p>
			...
			<br />
			<p><img src="http://account.imagineretailer.com/images/social-media/facebook/current-ad/step5.jpg" class="image-border" width="750" height="203" alt="<?php echo _('Step 5'); ?>" /></p>
			<br />
			...
			<p><a href="/social-media/facebook/current-ad/" title="<?php echo _('Activate'); ?>"><?php echo _('Activate'); ?></a></p>
			<br />
