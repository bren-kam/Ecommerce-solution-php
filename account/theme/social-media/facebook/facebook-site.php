        ...
        if ( !isset( $facebook_site['fb_page_id'] ) || 0 == $facebook_site['fb_page_id'] ) {
            ...
            foreach ( $instructions as $step => $data ) {
                ...
                if ( !isset( $data['image'] ) || $data['image'] != false )
                    echo '<br /><p><a href="http://account.imagineretailer.com/images/social-media/facebook/facebook-site/', $step, '.jpg"><img src="http://admin.imagineretailer.com/images/social-media/facebook/about-us/', $step, '.jpg" alt="', $data['title'], '" width="750" /></a></p>';
