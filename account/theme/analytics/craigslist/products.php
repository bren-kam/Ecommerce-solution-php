...
// Get the analytics
$records = $a->get_craigslist_metric_by_date( 'product', 'views', $craigslist_market_id );
$total = $a->get_craigslist_totals( 'product', $craigslist_market_id );
...
$products = $a->get_craigslist_overview( 'products', $craigslist_market_id, '', '', 0 );
...
$selected = "analytics";
$title = _('Products') . ' | ' . $market['market'] . ' | ' . _('Craigslist') . ' | ' . _('Analytics') . ' | ' . TITLE;
get_header();
?>
...
<div id="content">
	...
	<h1><?php echo $market['market'], ' - ', _('Products'); ?></h1>
	<br clear="all" /><br />
	...
	<div id="subcontent">
		...
		<div class="info-box col-1">
			<p class="info-box-title"><?php echo $market['market'], ' - ', _('Products'); ?></p>
        ...
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="dt" perPage="30,50,100">
                    <thead>
                        <tr>
                            <th width="40%" sort="1 desc"><?php echo _('Product'); ?></th>
