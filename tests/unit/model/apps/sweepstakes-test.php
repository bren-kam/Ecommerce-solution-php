...
class SweepstakesTest extends BaseDatabaseTest {
    ...
    public function testGetTabA() {
        ...
        // Insert About Us
        $this->db->insert( 'sm_sweepstakes', array( 'fb_page_id' => $fb_page_id, 'before' => $before ), 'is' );
        ...
        // Delete it
        $this->db->delete( 'sm_sweepstakes', array( 'fb_page_id' => $fb_page_id ), 'i' );
    }
    ...
    public function testGetTabB() {
        ...
        // Insert About Us
        $this->db->insert( 'sm_sweepstakes', array( 'fb_page_id' => $fb_page_id, 'after' => $after ), 'is' );
    ...
    public function testGetConnectedWebsite() {
        ...
        $this->db->insert( 'sm_sweepstakes', array( 'sm_facebook_page_id' => $sm_facebook_page_id, 'fb_page_id' => $fb_page_id, 'key' => $key ), 'iis' );
    ...
    public function testConnect() {
        ...
        // Insert About Us
        $this->db->insert( 'sm_sweepstakes', array( 'key' => $key,  ), 's' );

        // Get it
        $this->sweepstakes->connect( $fb_page_id, $key );

        // Get the key
        $fetched_fb_page_id = $this->db->get_var( "SELECT `fb_page_id` FROM `sm_sweepstakes` WHERE `key` = '$key'" );

        $this->assertEquals( $fb_page_id, $fetched_fb_page_id );

        // Delete it
        $this->db->delete( 'sm_sweepstakes', array( 'key' => $key ), 'i' );
    }
