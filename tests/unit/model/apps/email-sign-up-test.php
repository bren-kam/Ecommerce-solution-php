...
class EmailSignUpTest extends BaseDatabaseTest {
    ...
    public function testGetTab() {
        ...
        // Insert About Us
        $this->db->insert( 'sm_email_sign_up', array( 'fb_page_id' => $fb_page_id, 'tab' => $content ), 'is' );
        ...
        // Delete it
        $this->db->delete( 'sm_email_sign_up', array( 'fb_page_id' => $fb_page_id ), 'i' );
    }
    ...
    public function testGetConnectedWebsite() {
        ...
        $this->db->insert( 'sm_email_sign_up', array( 'sm_facebook_page_id' => $sm_facebook_page_id, 'fb_page_id' => $fb_page_id, 'key' => $key ), 'iis' );
    ...
    public function testConnect() {
        ...
        // Insert About Us
        $this->db->insert( 'sm_email_sign_up', array( 'key' => $key,  ), 's' );

        // Get it
        $this->email_sign_up->connect( $fb_page_id, $key );

        // Get the key
        $fetched_fb_page_id = $this->db->get_var( "SELECT `fb_page_id` FROM `sm_email_sign_up` WHERE `key` = '$key'" );

        $this->assertEquals( $fb_page_id, $fetched_fb_page_id );

        // Delete it
        $this->db->delete( 'sm_email_sign_up', array( 'key' => $key ), 'i' );
    }
