...
( [website_id], 'current-offer', 'Yes! Email My Special Coupon Offer Now', '&lt;p&gt;Receive Exclusive Tips, Trends, Special Offers and Online Only Sales from ABC Furniture.&lt;/p&gt;', '', '', '', 1, NOW()),
...
( [website_id], 'brands', 'Brands', '', '', '', '', 1, NOW())" );
	}
