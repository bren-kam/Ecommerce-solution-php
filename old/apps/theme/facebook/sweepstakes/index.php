...
// Instantiate Classes
$fb = new FB( '113993535359575', '16937c136a9c5237b520b075d0ea83c8', 'op-sweepstakes' );
$s = new Sweepstakes;
$v = new Validator;
...
if( $other_user_id == $user && $page_id ) {
	if( nonce::verify( $_POST['_nonce'], 'connect-to-field' ) ) {
		...
		if( empty( $errs ) )
			$success = $s->connect( $page_id, $_POST['tFBConnectionKey'] );
	}
}

// Get the website
if( $page_id )
	$website = $s->get_connected_website( $page_id );

add_footer('<div id="fb-root"></div>
<script>
  window.fbAsyncInit = function() {
    FB.init({appId: "113993535359575", status: true, cookie: true,
             xfbml: true});
...
?>
	        ...
	        <div id="apps-container" class="clear">
	            ...
	            <div id="apps-content" class="clear">
	                ...
	                <div id="apps-desc">
	                    ...
	                    <p><a href="#" onclick="top.location.href='http://www.facebook.com/add.php?api_key=113993535359575&pages=1'"title="Install this App" class="install-app"><img src="https://www.greysuitapps.com/fb/images/trans.gif" alt="Install this App" /></a></p>
	...
	<div id="content">
		<form name="fConnect" id="fConnect" method="post" action="/facebook/sweepstakes/">
