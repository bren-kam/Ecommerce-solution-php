...
javascript( 'jquery', 'data-tables/jquery.dataTables', 'data-tables/ZeroClipboard/ZeroClipboard.js', 'data-tables/jquery.tableTools.js', 'requests/disapproved' );
	...
	<div id="subcontent">
        <div id="dRequestsContainer">
            ...
            <table cellpadding="0" cellspacing="0" width="100%" id="tListRequests">
                <thead>
                    <tr>
                        <th width="15%" class="center"><?php echo _('Date Disapproved'); ?></th>
