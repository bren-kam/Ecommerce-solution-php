...
<div id="content">
	...
	<table cellpadding="0" cellspacing="0">
		...
		<tr>
			<td><strong><?php echo _('Website'); ?>:</strong> <a href="http://<?php if ( !empty( $ticket['subdomain'] ) ) echo $ticket['subdomain'], '.'; echo $ticket['domain']; ?>/" title="<?php echo $ticket['website']; ?>" target="_blank"><?php echo $ticket['website']; ?></a> (<a href="/accounts/control/?wid=<?php echo $ticket['website_id']; ?>" target="_blank" title="<?php echo _('Control'); ?>"><?php echo _('Control'); ?></a>)</td>
