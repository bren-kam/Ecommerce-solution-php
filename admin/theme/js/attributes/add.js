...
function postLoad( $ ) {
	...
	$('#aAddListItem').click( function() {
		...
		for( i in itemNames ) {
			...
			newListItem += '<div style="display:inline;float:right"><a href="javascript:;" title=\'Edit "' + itemName + '" List Item\' class="edit-list-item"><img src="/images/icons/edit.png" alt=\'Edit "' + itemName + '" List Item\' width="15" height="17" /></a> <a href="javascript:;" class="delete-list-item" title=\'Delete "' + itemName + '" List Item\'><img src="/images/icons/x.png" width="15" height="17" alt=\'Delete "' + itemName + '" List Item\' /></a></div></div></div>';
