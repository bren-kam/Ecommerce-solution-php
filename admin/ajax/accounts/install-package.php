...
if ( isset( $_POST['_nonce'] ) && nonce::verify( $_POST['_nonce'], 'install-package' ) ) {
	...
	echo json_encode( array( 'success' => $response->success(), 'theme' => $response->get('theme'), 'message' => _('You have successfully installed the package! Please make sure you "Save" at the bottom of the page.'), 'error' => _('An error occurred while trying to install a package. Please contact a system administrator.') ) );
} else {
