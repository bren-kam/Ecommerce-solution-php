...
if ( '0' == $_POST['hTicketID'] ) {
	$ajax->ok( $t->create( format::links_to_anchors( $_POST['tTicketSummary'] ), $_POST['taTicket'] ), _('An error occurred while trying to create your ticket. Please refresh the page and try again') );
} else {
