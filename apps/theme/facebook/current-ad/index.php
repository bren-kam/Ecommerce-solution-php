...
// Instantiate Classes
$fb = new FB( '186618394735117', 'd4cbf0c45ed772cf1ca0d98e0adb1383', 'current-ad' );
$ca = new Current_Ad;
$v = new Validator;
...
?>
    	...
    	<div id="apps" class="fb-tab-wrapper">
	        ...
	        <div id="apps-container" class="clear">
		        ...
		        <div id="apps-content" class="clear">
	                <div id="apps-icon">
	                    <img src="http://www.greysuitapps.com/fb/images/icons/ad.png" alt="Ads" />
	                </div>
	                <div id="apps-desc">
	                    <h1>Current Ad</h1>
	                    ...
	                    <p><a href="#" onclick="top.location.href='http://www.facebook.com/add.php?api_key=186618394735117&pages=1'"title="Install this App" class="install-app"><img src="http://www.greysuitapps.com/fb/images/trans.gif" alt="Install this App" /></a></p>
	...
	<div id="content">
		<form name="fConnect" method="post" action="/facebook/current-ad/">
