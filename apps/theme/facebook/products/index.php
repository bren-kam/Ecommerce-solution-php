...
<div id="content">
	<h1><?php echo _('Online Platform - Products'); ?></h1>
	...
	?>
	<ol>
		<li>Go to this page: <a href="javascript:top.location.href='http://www.facebook.com/apps/application.php?id=163636730371197';" title="Online Platform - Products">Online Platform - Products</a> and click "Add to My Page" in the left-hand bar, select your page and add it.</li>
		<li>Go to the page you selected, click on the "Products" tab and click "Update Settings" to connect to your page to the platform.</li>
	</ol>
	<?php } else { ?>
	<form name="fConnect" method="post" action="/facebook/products/<?php if( isset( $_GET['app_data'] ) ) echo '?app_data=' . $_GET['app_data']; ?>">
