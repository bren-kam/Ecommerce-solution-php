...
// Instantiate Classes
$fb = new FB( '245607595465926', 'b29a7efe3a1329bae0b425de96acd84b', 'op-contact-us' );
$cu = new Contact_Us;
$v = new Validator;
...
if( $other_user_id == $user && $page_id ) {
	if( nonce::verify( $_POST['_nonce'], 'connect-to-field' ) ) {
		...
		if( empty( $errs ) )
			$success = $cu->connect( $page_id, $_POST['tFBConnectionKey'] );
	}
}

// Get the website
if( $page_id )
	$website = $cu->get_connected_website( $page_id );

add_footer('<div id="fb-root"></div>
<script>
  window.fbAsyncInit = function() {
    FB.init({appId: "245607595465926", status: true, cookie: true,
             xfbml: true});
...
?>
    ...
    <div id="content">
    	<div id="apps" class="fb-tab-wrapper">
	        ...
	        <div id="apps-container" class="clear">
                ...
                <div id="apps-icon">
                    <img src="http://www.greysuitapps.com/fb/images/icons/contact.png" alt="Contact Us" />
                </div>
                <div id="apps-desc">
                    <h1>Contact Us</h1>
                    ...
                    <ul>
	                    ...
	                    <p><a href="#" onclick="top.location.href='http://www.facebook.com/add.php?api_key=245607595465926&pages=1'"title="Install this App" class="install-app"><img src="http://www.greysuitapps.com/fb/images/trans.gif" alt="Install this App" /></a></p>
	...
	<div id="content">
		<form name="fConnect" method="post" action="/facebook/contact-us/">
