...
<div id="content">
	<h1><?php echo _('Online Platform - Contact Us'); ?></h1>
	...
	?>
	<ol>
		<li>Go to this page: <a href="javascript:top.location.href='http://www.facebook.com/apps/application.php?id=245607595465926';" title="Online Platform - Contact Us">Online Platform - Contact Us</a> and click "Add to My Page" in the left-hand bar, select your page and add it.</li>
	...
	<?php } else { ?>
	<form name="fConnect" method="post" action="/facebook/contact-us/<?php if( isset( $_GET['app_data'] ) ) echo '?app_data=' . $_GET['app_data']; ?>">
