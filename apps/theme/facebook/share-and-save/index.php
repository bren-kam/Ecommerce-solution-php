...
// Instantiate Classes
$fb = new FB( '118945651530886', 'ef922d64f1f526079f48e0e0efa47fb7', 'share-and-save' );
...
?>
    	...
    	<div id="apps" class="fb-tab-wrapper">
	        ...
	        <div id="apps-container" class="clear">
	            ...
	            <div id="apps-content" class="clear">
					<div id="apps-icon">
                    	<img src="http://www.greysuitapps.com/fb/images/icons/share-save.png" alt="Share &amp; Save" />
	                </div>
	                <div id="apps-desc">
	                    <h1>Share &amp; Save</h1>
	                    ...
	                    <p><a href="#" onclick="top.location.href='http://www.facebook.com/add.php?api_key=118945651530886&pages=1'"title="Install this App" class="install-app"><img src="http://www.greysuitapps.com/fb/images/trans.gif" alt="Install this App" /></a></p>
	...
	<div id="content">
		<form name="fConnect" id="fConnect" method="post" action="/facebook/share-and-save/">
