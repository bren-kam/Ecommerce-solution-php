...
<form name="fAddEditProduct" id="fAddEditProduct" action="<?php if ( $product->id ) echo '?pid=' . $product->id; ?>" method="post" err="<?php echo _('Products require at least one image to create'); ?>">
    ...
    <div id="main-container">
        <div id="main">
            ...
            <a href="#" id="aUpload" class="button" title="<?php echo _('Upload'); ?>" err="<?php echo _('You must select an Industry before uploading an image'); ?>"><?php echo _('Upload'); ?></a>
            <a href="#" class="button loader hidden" id="upload-loader" title="<?php echo _('Loading'); ?>"><img src="/images/buttons/loader.gif" alt="<?php echo _('Loading'); ?>" /></a>
