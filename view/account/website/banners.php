...
<div id="dBannerBoxes">
    ...
    $update_status_nonce = nonce::create('update_status');
    ...
    foreach ( $attachments as $a ) {
        ...
        ?>
        <div class="banner-box<?php echo $disabled; ?>" id="dAttachment_<?php echo $a->id; ?>">
            ...
            <form action="/website/update-extra/" method="post" ajax="1">
                ...
                <?php nonce::field( 'update_extra', '_nonce' ); ?>
            </form>
            <?php
