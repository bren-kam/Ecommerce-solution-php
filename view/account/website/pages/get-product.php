...
<div class="float-left">
	...
	<table class="float-left form">
		...
		<tr><td colspan="2" class="text-center">
            <a href="<?php echo url::add_query_arg( array( '_nonce' => nonce::create('add_product'), 'pid' => $product->id ), '/website/add-product/' ); ?>" class="add-product button" title="<?php echo _('Add Product'); ?>"><?php echo _('Add Product'); ?></a>
        </td></tr>
	</table>
</div>
<br clear="left" />