var ReachCommentForm = {
    ...
    , delete: function () {
        ...
        $.post(
            '/products/reaches/delete-comment/'
...
var ReachView = {
    ...
    , updatePriority: function() {
        ...
        $.post(
            '/products/reaches/update-priority/'
    ...
    , updateStatus: function() {
        $.post(
            '/products/reaches/update-status/'
    ...
    , assignTo: function() {
        ...
        $.post(
            '/products/reaches/update-assigned-to/'
