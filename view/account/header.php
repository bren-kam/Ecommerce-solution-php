		...
		<div id="nav-links">
            ...
            foreach ( $links as $key => $link ) {
                ...
                switch ( $key ) {
                    ...
                    <a href="javascript:document.getElementById('fBlogForm').submit();" title="<?php echo $link[1]; ?>"<?php $template->select( $key, true ); ?>><?php echo $link[1]; ?></a>
                    <?php
                    break;

                    default:
                        ?>
                        <a href="/<?php echo $link[0]; ?>/" title="<?php echo $link[1]; ?>"<?php $template->select( $key, true ); ?>><?php echo $link[1]; ?></a>
                        <?php
                    break;
                }
            }
