...
<div id="sidebar">
    ...
    <a href="/authorized-users/" title="<?php echo _('Authorized Users'); ?>" class="top <?php $template->select('authorized-users'); ?>"><?php echo _('Authorized Users'); ?></a>
    <?php if ( $template->v('authorized-users') ) { ?>
    <a href="/authorized-users/add-edit/" title="<?php echo _('Add'); ?>" class="sub add<?php $template->select('add'); ?>"><?php echo _('Add'); ?></a>
    <?php } ?>
