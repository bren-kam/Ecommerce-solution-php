                    ...
                    if ( !$products->fb_page_id ) :
                        ...
                        foreach ( $instructions as $step => $data ):
                            ...
                            if ( !isset( $data['image'] ) || $data['image'] != false )
                                echo '<p><a href="http://account.imagineretailer.com/images/social-media/facebook/products/', $step, '.png"><img src="http://account.imagineretailer.com/images/social-media/facebook/products/', $step, '.png" alt="', $data['title'], '" /></a></p>';
                ...
                ?>
                        ...
                        <form method="post" role="form">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="taContent" name="taContent" rte="1" rows="10"><?php echo $products->content ?></textarea>
                            </div>
                            <p>
