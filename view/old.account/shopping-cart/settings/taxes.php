...
<form name="fTaxes" id="fTaxes" action="/shopping-cart/settings/taxes/" method="post">
    <table id="tWebsiteTaxes" width="700">
        ...
        foreach ( $taxes['states'] as $abbr => $tax ) {
            ...
            <tr id="trTax<?php echo $abbr; ?>">
                <td>
                    ...
                    <textarea name="zip_codes[<?php echo $abbr; ?>]" class="hidden" col="50" rows="3" placeholder="[Zip] [Cost]"><?php
        ...
        <tr id="trAddTax">
            ...
            <td><input type="text" class="tb" name="tAmount" id="tAmount" maxlength="5" placeholder="<?php echo _('Amount'); ?>" /></td>
