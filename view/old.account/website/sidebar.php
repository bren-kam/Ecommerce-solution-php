<<<<<<< HEAD:view/account/website/sidebar.php
<?php
/**
...
<div id="sidebar">
    ...
    <?php if ( $template->v('settings') ) { ?>
        ...
        <?php if ( $user->account->is_new_template() && $user->has_permission( User::ROLE_ONLINE_SPECIALIST ) ) { ?>
...
<div id="sidebar">
    ...
    <?php if ( $template->v('settings') ) { ?>
        ...
        <?php } ?>
    <?php } ?>
>>>>>>> feature-new-skin:view/old.account/website/sidebar.php
</div>