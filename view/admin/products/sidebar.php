...
<div id="sidebar">
    <div id="actions">
        ...
        <a href="/categories/" title="<?php echo _('Categories'); ?>" class="top<?php $template->select('categories'); ?>"><?php echo _('Categories'); ?></a>
        ...
        <a href="/attributes/" title="<?php echo _('Attributes'); ?>" class="top<?php $template->select('attributes'); ?>"><?php echo _('Attributes'); ?></a>
        <?php if ( isset( $categories ) && true === $categories ) { ?>
        ...
        <a href="/brands/" title="<?php echo _('Brands'); ?>" class="top<?php $template->select('brands'); ?>"><?php echo _('Brands'); ?></a>
        ...
        <a href="/product-options/" title="<?php echo _('Product Options'); ?>" class="top<?php $template->select('product_options'); ?>"><?php echo _('Product Options'); ?></a>
