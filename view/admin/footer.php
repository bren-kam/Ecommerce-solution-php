...
<!-- End: Footer -->
<script type="text/javascript">head.js( 'http://code.jquery.com/jquery-1.9.1.min.js', 'http://code.jquery.com/jquery-migrate-1.1.0.js', '/resources/js/?f=<?php echo $resources->get_javascript_file(); ?>');</script>
