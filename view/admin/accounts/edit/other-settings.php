...
<div id="tabs">
    ...
    <div class="tab-link"><a href="/accounts/edit/other-settings/?aid=<?php echo $account->id; ?>" class="selected" title="<?php echo _('Other Settings'); ?>"><?php echo _('Other Settings'); ?></a></div>
