...
<div id="tabs">
    ...
    <div class="tab-link"><a href="/accounts/edit/website-settings/?aid=<?php echo $account->id; ?>" class="selected" title="<?php echo _('Website Settings'); ?>"><?php echo _('Website Settings'); ?></a></div>
...
<h3><?php echo _('Website Settings'); ?></h3>
