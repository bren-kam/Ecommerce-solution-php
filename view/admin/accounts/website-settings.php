...
<div id="tabs">
    ...
    <div class="tab-link"><a href="/accounts/website-settings/?aid=<?php echo $account->id; ?>" class="selected" title="<?php echo _('Website Settings'); ?>"><?php echo _('Website Settings'); ?></a></div>
