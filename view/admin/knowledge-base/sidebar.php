...
<div id="sidebar">
    <div id="actions">
        <a href="<?php echo url::add_query_arg( 's', KnowledgeBaseCategory::SECTION_ADMIN, '/knowledge-base/articles/' ); ?>" title="<?php echo _('Articles'); ?>" class="top first<?php $template->select('articles'); ?>"><?php echo _('Articles'); ?></a>
        <?php if ( $template->v('articles') ) { ?>
            <a href="<?php echo url::add_query_arg( 's', KnowledgeBaseCategory::SECTION_ADMIN, '/knowledge-base/articles/' ); ?>" title="<?php echo _('View'); ?>" class="sub view first<?php $template->select('view'); ?>"><?php echo _('View'); ?></a>
            <a href="<?php echo url::add_query_arg( 's', KnowledgeBaseCategory::SECTION_ADMIN, '/knowledge-base/articles/add-edit/' ); ?>" title="<?php echo _('Add'); ?>" class="sub add<?php $template->select('add'); ?>"><?php echo _('Add'); ?></a>
        <?php } ?>
